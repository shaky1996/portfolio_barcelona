...
})({"7ppK9":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "3ba1e06cf7e5f8d9";
"use strict";
...
const fetchLastResult = async ()=>{
    ...
    try {
        ...
        if (data.response && data.response[0]) return data.response[0]; // Return the last result data
        else throw new Error("Error: Last result data is missing.");
    } catch (error) {
...
//# sourceMappingURL=index.f7e5f8d9.js.map
